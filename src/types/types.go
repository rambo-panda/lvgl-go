...
const (
	...
	LV_ALIGN_TOP_MID      LvAlignT = C.LV_ALIGN_TOP_MID
	LV_ALIGN_TOP_RIGHT    LvAlignT = C.LV_ALIGN_TOP_RIGHT
	LV_ALIGN_BOTTOM_LEFT  LvAlignT = C.LV_ALIGN_BOTTOM_LEFT
	LV_ALIGN_BOTTOM_MID   LvAlignT = C.LV_ALIGN_BOTTOM_MID
	LV_ALIGN_BOTTOM_RIGHT LvAlignT = C.LV_ALIGN_BOTTOM_RIGHT
	LV_ALIGN_LEFT_MID     LvAlignT = C.LV_ALIGN_LEFT_MID
	LV_ALIGN_RIGHT_MID    LvAlignT = C.LV_ALIGN_RIGHT_MID
	LV_ALIGN_CENTER       LvAlignT = C.LV_ALIGN_CENTER

	LV_ALIGN_OUT_TOP_LEFT     LvAlignT = C.LV_ALIGN_OUT_TOP_LEFT
	LV_ALIGN_OUT_TOP_MID      LvAlignT = C.LV_ALIGN_OUT_TOP_MID
	LV_ALIGN_OUT_TOP_RIGHT    LvAlignT = C.LV_ALIGN_OUT_TOP_RIGHT
	LV_ALIGN_OUT_BOTTOM_LEFT  LvAlignT = C.LV_ALIGN_OUT_BOTTOM_LEFT
	LV_ALIGN_OUT_BOTTOM_MID   LvAlignT = C.LV_ALIGN_OUT_BOTTOM_MID
	LV_ALIGN_OUT_BOTTOM_RIGHT LvAlignT = C.LV_ALIGN_OUT_BOTTOM_RIGHT
	LV_ALIGN_OUT_LEFT_TOP     LvAlignT = C.LV_ALIGN_OUT_LEFT_TOP
	LV_ALIGN_OUT_LEFT_MID     LvAlignT = C.LV_ALIGN_OUT_LEFT_MID
	LV_ALIGN_OUT_LEFT_BOTTOM  LvAlignT = C.LV_ALIGN_OUT_LEFT_BOTTOM
	LV_ALIGN_OUT_RIGHT_TOP    LvAlignT = C.LV_ALIGN_OUT_RIGHT_TOP
	LV_ALIGN_OUT_RIGHT_MID    LvAlignT = C.LV_ALIGN_OUT_RIGHT_MID
	LV_ALIGN_OUT_RIGHT_BOTTOM LvAlignT = C.LV_ALIGN_OUT_RIGHT_BOTTOM
)
