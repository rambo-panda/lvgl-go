...
func CreateImg(o *lib.LvObjT) SetImg {
	return SetImg{
		CStructLvObjT: (*C.struct__lv_obj_t)(unsafe.Pointer(o)),
	}
}

func (setter SetImg) GetObj() *lib.LvObjT {
...
func (setter SetImg) BufSetPxColor(dsc *lib.LvImgDscT, x lib.LvCoordT, y lib.LvCoordT, c lib.LvColorT) SetImg {
	C.lv_img_buf_set_px_color((*C.lv_img_dsc_t)(unsafe.Pointer(dsc)), C.lv_coord_t(x), C.lv_coord_t(y), C.lv_color_t(c))

	return setter
}
func (setter SetImg) BufSetPxAlpha(dsc *lib.LvImgDscT, x lib.LvCoordT, y lib.LvCoordT, opa lib.LvOpaT) SetImg {
	C.lv_img_buf_set_px_alpha((*C.lv_img_dsc_t)(unsafe.Pointer(dsc)), C.lv_coord_t(x), C.lv_coord_t(y), C.lv_opa_t(opa))

	return setter
}
func (setter SetImg) BufSetPalette(dsc *lib.LvImgDscT, id uint8, c lib.LvColorT) SetImg {
	C.lv_img_buf_set_palette((*C.lv_img_dsc_t)(unsafe.Pointer(dsc)), C.uint8_t(id), C.lv_color_t(c))

	return setter
}

func (setter SetImg) DecoderSetInfoCb(decoder *lib.LvImgDecoderT, info_cb lib.LvImgDecoderInfoFT) SetImg {
	C.lv_img_decoder_set_info_cb((*C.lv_img_decoder_t)(unsafe.Pointer(decoder)), C.lv_img_decoder_info_f_t(info_cb))

	return setter
}
func (setter SetImg) DecoderSetOpenCb(decoder *lib.LvImgDecoderT, open_cb lib.LvImgDecoderOpenFT) SetImg {
	C.lv_img_decoder_set_open_cb((*C.lv_img_decoder_t)(unsafe.Pointer(decoder)), C.lv_img_decoder_open_f_t(open_cb))

	return setter
}
func (setter SetImg) DecoderSetReadLineCb(decoder *lib.LvImgDecoderT, read_line_cb lib.LvImgDecoderReadLineFT) SetImg {
	C.lv_img_decoder_set_read_line_cb((*C.lv_img_decoder_t)(unsafe.Pointer(decoder)), C.lv_img_decoder_read_line_f_t(read_line_cb))

	return setter
}
func (setter SetImg) DecoderSetCloseCb(decoder *lib.LvImgDecoderT, close_cb lib.LvImgDecoderCloseFT) SetImg {
