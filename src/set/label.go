...
func StaticForLabel(obj *lib.LvObjT, text string) {
	C.lv_label_set_text_static((*C.struct__lv_obj_t)(unsafe.Pointer(obj)), C.CString(text))

}
func ModeForLabel(obj *lib.LvObjT, long_mode lib.LvLabelLongModeT) {
...
func StartForLabel(obj *lib.LvObjT, index uint32) {
	C.lv_label_set_text_sel_start((*C.struct__lv_obj_t)(unsafe.Pointer(obj)), C.uint(index))

}
func EndForLabel(obj *lib.LvObjT, index uint32) {
